            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="naver_ba.jpg" alt="">
                            <div class="caption">
                                <h4 class="pull-right">NickName</h4>
                                <h4><a href="index - item.html">NAVERê²ìì´</a>
                                </h4>
                                <p>ì¤ìê°ì¼ë¡ ë¤ì´ë² ê²ìì´ ììë¥¼ ë³¼ ì ìë¤.</p>
                            </div>
                            <div class="ratings">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="calc_ba.jpg" alt="">
                            <div class="caption">
                                <h4 class="pull-right">ëë¤ì</h4>
                                <h4><a href="#">ì¹ ê³ì°ê¸°</a>
                                </h4>
                                <p>ê°ë¨í ê³ì°ê¸° ì¹ì´ë¤.</p>
                            </div>
                            <div class="ratings">
