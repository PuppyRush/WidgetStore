...
<%
	...
	HashMap<String, Object> results = VerifyPage.Verify(session.getId(), enumPage.MANAGE_EVALUATING_WIDGET);
...
<link href="/AdminPage/css/jqueryFileTree.css" rel="stylesheet"
	type="text/css" media="screen" />
<link href="/AdminPage/css/bootstrap-datetimepicker.min.css"
	rel="stylesheet" media="screen">
<link rel="stylesheet"
	href="//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.7.0/styles/default.min.css">

<link class="codestyle" rel="prefetch alternate stylesheet"
	href="/library/highlight/styles/default.css">
<link class="codestyle" rel="prefetch alternate stylesheet"
	href="/library/highlight/styles/solarized-dark.css">
<link class="codestyle" rel="prefetch alternate stylesheet"
	href="/library/highlight/styles/solarized-light.css">
...
<body>
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					<li class="active"><a
						href="<%=enumPage.MANAGE_MEMBER.toString()%>"><i
							class="glyphicon glyphicon-th-list"></i> 유저 관리</a></li>
					<li><a
						href="<%=enumPage.MANAGE_EVALUATING_WIDGET.toString()%>"><i
					...
					<div class="row">
						...
						<div id="snippet">
							...
							<div id="control">
								...
								<p>
									style: <a id="style-link"
										href="/AdminPage/adminPage_widget.jsp?snippet=9&amp;style=10">zenburn</a>
							</div>
	...
	<script type="text/javascript" src="/AdminPage/js/commanJs.js"
		charset="UTF-8"></script>
...
var _sourceRoot;
 ...
 function accept(_idx){
	 ...
	 var widgetName = _widgets[_idx].get("widgetName");
	 var userId = _widgets[_idx].get("userId");
	 ...
	 //jQuery의 Post함수로 입력받은 id값 전달 
				  $.ajax({
					   url: '/acceptWidget.do',
					   type: 'POST',
					   data: {'evalId':evalId,"widgetRoot":widgetRoot,"widgetName":widgetName, "userId":userId },
					   dataType: 'json',
...
window.onload=function(){
	...
	<%if (widgets.size() > 0) {%>
			...
			<%for (int i = 0; i < widgets.size(); i++) {%>
				...
				map.put("userId", "<%=widgets.get(i).getUserId()%>");
